...
const Form = ({user}) => {
    ...
    const handleSubmit=async (e)=>{
        ...
        // 4) yeni tweet dökümanını kolleksiyona kaydet
  ...
  return (
    <form onSubmit={handleSubmit} className='gap-3 flex border-b border-zinc-600 p-4'>
        ...
        <div className='w-full'>
            ...
            <div className='flex justify-between items-center'>
                <label className='text-lg transition p-4 cursor-pointer rounded-full hover:bg-gray-800' htmlFor="image"><BsCardImage/></label>
