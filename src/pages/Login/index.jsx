...
const Login = () => {
    ...
    const handleSubmit=(e)=>{
        ...
        if(isSignUp){
            ...
            // giriş yapma modundaysa hesaba giriş yapacagız
            ...
            .catch((err)=>{
                // eger giris bilgileri yanlıs geldiyese:
                if(err.code==="auth/invalid-credential"){
                    //error state ini true ya cekiyoruz
                    setIsError(true)
                }
    ...
    <div className='h-screen bg-[#242424] text-white grid place-items-center'>
        <div className='bg-black flex flex-col gap-10 py-16 px-32 rounded-lg'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col'>
                ...
                <button className='mt-10 bg-white text-black rounded-full p-1 font-bold transition hover:bg-gray-300'>{isSignUp ? "Kaydolun" : "Giriş Yap"} </button>
            </form>
            <p className='mt-5'>
